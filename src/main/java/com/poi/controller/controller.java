...
public class controller {
    ...
    List<GongWeiFuHe> selectAllGongWeiFuHe(Integer pageNum,int limit)throws Exception{
        return gongWeiFuHeService.selectAllGongWeiFuHe(pageNum.intValue(),limit);
    }
    ...
    public List<GuoChenFuHe> selectAllGuoChenFuHe(int pageNum,int limit)throws Exception{
        ...
        return guoChenFuHeService.selectAllGuoChenFuHe(pageNum,limit);
    };
    ...
    @ResponseBody
    @RequestMapping("/deletGuoChenByid")
    void deletGuoChenByid(int id){
        guoChenFuHeService.deletGuoChenByid(id);
    }
